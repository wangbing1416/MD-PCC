...
parser.add_argument('--model_name', default='bert', help='bert, bertemo, eann, mdfend')
...
pretrain_model = {  # checkpoint of pre-trained models downloaded from huggingface.com
    'gossip': '../huggingface/bert-base-uncased',
    'weibo': '../huggingface/chinese-bert-wwm-ext',
    'ours': '../huggingface/chinese-bert-wwm-ext',
    'politifact': '../huggingface/bert-base-uncased',
    'snopes': '../huggingface/bert-base-uncased'
}
...
args.pretrain_name = pretrain_model[args.dataset]
